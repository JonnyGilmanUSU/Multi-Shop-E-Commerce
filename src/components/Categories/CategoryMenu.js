...
const CategoryMenu = () => {
   ...
   // Make sure categories exist before rendering
    ...
    return ( 
        ...
        <Link className={`btn d-flex align-items-center justify-content-between bg-primary w-100`} data-toggle="collapse" data-target="#navbar-vertical" to="#navbar-vertical" style={{height: '65px', padding: '0 30 px'}} >
